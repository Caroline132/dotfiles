...
vim.keymap.set({ "n" }, "<leader>te", "<cmd>Neotree show toggle left<cr>", { desc = "Toggle neotree" })
...
vim.keymap.set({ "n" }, "<leadvim.keymap.seter>E", "<cmd>Neotree filesystem focus reveal left<cr>", { desc = "Neotree show file" })
