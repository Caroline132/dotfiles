...
vim.keymap.set("n", "<leader>gB", Snacks.picker.git_log_file, { desc = "Buffer commits" })
vim.keymap.set("n", "<leader>gc", Snacks.picker.git_log, { desc = "Commits" })
vim.keymap.set("n", "<leader>gd", Snacks.picker.git_diff, { desc = "Diff" })
